...
[HarmonyPatch]
internal static class EasyCraft_ClosestItemContainers_DestroyItem_Patch
{
	public static bool Prepare()
	{
		...
		return AccessTools.Method(containersType, "DestroyItem", new Type[2]
		{
			typeof(TechType),
			typeof(int)
		}, (Type[])null) != null;
	...
	{
		return AccessTools.Method(EasyCraftCompat.ContainersType, "DestroyItem", new Type[2]
		{
			typeof(TechType),
			typeof(int)
		}, (Type[])null);
